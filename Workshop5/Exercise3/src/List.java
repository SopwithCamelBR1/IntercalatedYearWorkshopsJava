 ...
 * @author acb131
 * 
 * Copied directly from example given by Manfred Kerber.
 *
 */
public class List {
     ...
     * @param tail
     */
    public List(ArrayList<Integer> head, List tail) {
        this.empty = false; 
        this.head = head;
        this.tail = tail;
    }
     ...
     */
    public static List cons(ArrayList<Integer> head, List tail) {
